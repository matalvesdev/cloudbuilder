...
**Status**: ⚠️ **Planejado** — Kafka foi removido na Phase 1 ($0 infra cleanup). Estes diagramas documentam a arquitetura EDA pretendida para reintrodução futura via ADR-035.
