...
export function ComponentPalette({
  ...
  const filtered = useMemo(() => {
    return allComponents.filter((c) => {
      ...
      const matchProvider =
        activeProvider === "all" || c.provider === activeProvider;
      const matchCategory =
  ...
  const onDragStart = (event: DragEvent, component: ComponentDefinition) => {
    ...
    ghost.className =
      "fixed top-0 left-0 w-48 px-3 py-2 rounded-xl bg-white border border-brand-navy/20 shadow-xl flex items-center gap-2.5 text-sm font-medium text-brand-navy pointer-events-none z-[9999]";
  ...
  return (
    <div
      className={cn(
        ...
        variant === "sidebar"
          ? "bg-white"
          : "bg-white rounded-3xl card-shadow border border-slate-100",
      )}
    >
                      ...
                      <HoverCardTrigger asChild>
                        <div
                          ...
                          className={cn(
                            ...
                            dragItem === component.id
                              ? "opacity-50 scale-95 border-brand-navy shadow-md"
                              : "border-transparent",
                            pconf.hoverBg,
                            pconf.borderHover,
                          )}
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-1.5 mt-0.5">
                              ...
                              <span
                                ...
                                style={{
                                  color: providerMeta[component.provider].color,
                                }}
                              >
                          ...
                          <div
                            ...
                            style={{
                              backgroundColor:
                                providerMeta[component.provider].bg,
                              color: providerMeta[component.provider].color,
                            }}
                          >
                            {component.provider}
