...
const schemas: Record<string, PropertyField[]> = {
  ...
  aws_instance: [
    ...
    },
    {
      ...
      validation: {
        min: 8,
        max: 4096,
        message: "Must be between 8 and 4096 GB",
      },
    },
  ],
  ...
  aws_db_instance: [
    ...
    },
    {
      ...
      validation: {
        min: 5,
        max: 65536,
        message: "Must be between 5 and 65536 GB",
      },
    },
    {
      key: "storage_type",
  ...
  aws_lambda_function: [
    ...
    },
    {
      ...
      validation: {
        min: 128,
        max: 10240,
        message: "Must be between 128 and 10240 MB",
      },
    },
    {
      key: "timeout",
      ...
      validation: {
        min: 1,
        max: 900,
        message: "Must be between 1 and 900 seconds",
      },
    },
    {
      ...
      validation: {
        min: 512,
        max: 10240,
        message: "Must be between 512 and 10240 MB",
      },
    },
  ],
  ...
  aws_internet_gateway: [
    {
      ...
      type: "text",
      required: true,
      description: "The VPC ID to attach the gateway to",
    },
    {
      key: "tags",
      label: "Tags",
      type: "tags",
      required: false,
      description: "Key=value tags, one per line",
    },
  ],
  ...
  aws_autoscaling_group: [
    ...
    },
    {
      ...
      type: "tags",
      required: false,
      description: "Subnet IDs, one per line",
    },
  ],
  ...
  aws_dynamodb_table: [
    ...
    },
    {
      ...
      type: "text",
      required: false,
      description: "The sort key attribute name",
    },
  ],
  ...
  aws_ebs_volume: [
    {
      ...
      type: "text",
      required: true,
      description: "The AZ for the volume",
      placeholder: "us-east-1a",
    },
    {
      key: "size",
  ...
  aws_efs_file_system: [
    {
      ...
      description: "The performance mode",
    },
    {
      key: "throughput_mode",
      ...
      description: "The throughput mode",
    },
    {
      key: "encrypted",
      label: "Encrypted",
  ...
  aws_ecr_repository: [
    ...
    },
    {
      ...
      description: "The tag mutability setting",
    },
    {
      key: "scan_on_push",
      label: "Scan on Push",
  ...
  aws_sqs_queue: [
    ...
    },
    {
      ...
      required: false,
      defaultValue: 256,
      description: "The max message size in KB",
    ...
    },
    {
      ...
      required: false,
      defaultValue: 30,
      description: "The visibility timeout",
  ...
  aws_sns_topic: [
    ...
    },
    {
      ...
      type: "text",
      required: false,
      description: "The display name for email subscriptions",
    },
    {
      key: "fifo_topic",
      label: "FIFO Topic",
  ...
  aws_cloudwatch_metric_alarm: [
    ...
    },
    {
      ...
      options: [
        ...
        {
          label: "GreaterThanOrEqualToThreshold",
    ...
    },
    {
      ...
      type: "number",
      required: true,
      description: "The alarm threshold value",
    },
    {
  ...
  azurerm_subnet: [
    ...
    },
    {
      ...
      type: "cidr",
      required: true,
      description: "The address prefix CIDR",
  ...
  azurerm_kubernetes_cluster: [
    ...
    },
    {
      ...
      options: [
        { label: "Standard_D2s_v3", value: "Standard_D2s_v3" },
        { label: "Standard_D4s_v3", value: "Standard_D4s_v3" },
        { label: "Standard_D8s_v3", value: "Standard_D8s_v3" },
      ],
  ...
  azurerm_mssql_database: [
    ...
    },
    {
      ...
      type: "text",
      required: true,
      description: "The MSSQL server ID",
    },
    {
      key: "collation",
      label: "Collation",
      ...
      description: "The collation setting",
    },
    {
      key: "max_size_gb",
      label: "Max Size (GB)",
      ...
      required: false,
      defaultValue: 256,
      description: "The maximum size in GB",
    ...
    },
    {
      ...
      options: [
        { label: "GP_S_Gen5_1", value: "GP_S_Gen5_1" },
        { label: "GP_S_Gen5_2", value: "GP_S_Gen5_2" },
        { label: "GP_S_Gen5_4", value: "GP_S_Gen5_4" },
        { label: "BC_Gen5_2", value: "BC_Gen5_2" },
      ],
      description: "The service tier and hardware",
    },
  ],
  ...
  azurerm_storage_account: [
    ...
    },
    {
      ...
      description: "The performance tier",
    },
    {
  ...
  google_compute_network: [
    ...
    },
    {
      ...
      required: false,
      defaultValue: false,
      description: "Enable auto-creation of subnets",
    },
    {
      key: "routing_mode",
      label: "Routing Mode",
  ...
  google_compute_subnetwork: [
    ...
    },
    {
      ...
      required: false,
      defaultValue: false,
      description: "Enable access to Google APIs from private IPs",
    },
  ],
  ...
  google_sql_database_instance: [
    ...
    },
    {
      ...
      options: [
        { label: "db-f1-micro", value: "db-f1-micro" },
        { label: "db-g1-small", value: "db-g1-small" },
        { label: "db-custom-1-3840", value: "db-custom-1-3840" },
        { label: "db-custom-2-7680", value: "db-custom-2-7680" },
      ],
  ...
  kubernetes_namespace: [
    ...
    },
    {
      ...
      type: "tags",
      required: false,
      description: "Key=value labels, one per line",
    },
  ],
  ...
  kubernetes_config_map: [
    ...
    },
    {
      ...
      type: "tags",
      required: false,
      description: "Key=value entries, one per line",
    },
  ],
  ...
  kubernetes_secret: [
    ...
    },
    {
      ...
      type: "tags",
      required: false,
      description: "Base64-encoded key=value pairs, one per line",
    },
  ],
