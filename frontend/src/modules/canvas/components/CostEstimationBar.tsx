...
export function getResourcePrice(resourceType: string): number {
  // Exact match first
  if (LOCAL_PRICING[resourceType] !== undefined)
    return LOCAL_PRICING[resourceType]!;
      ...
      <div className="px-4 py-2 border-t border-slate-100 space-y-1">
        <div className="flex items-start gap-1.5">
          ...
          <p className="text-[10px] text-slate-400 leading-relaxed">
            Estimativa baseada em preços públicos de referência (USD). Custos
            reais podem variar conforme região, tier e uso.
          </p>
        </div>
