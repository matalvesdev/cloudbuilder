...
export function CanvasCommandPalette({
  ...
  const { addNode, autoLayout, duplicateSelected, clearCanvas } =
    useCanvasStore();
  ...
  return (
    <CommandDialog open={open} onOpenChange={onOpenChange}>
      <CommandInput
        placeholder="Buscar comandos ou componentes..."
        value={search}
      ...
      <CommandList>
        ...
        <CommandGroup heading="Ações">
          <CommandItem
            value="action:new"
            onSelect={() => handleSelect("action:new")}
          >
          ...
          <CommandItem
            value="action:save"
            onSelect={() => handleSelect("action:save")}
          >
          ...
          <CommandItem
            value="action:export"
            onSelect={() => handleSelect("action:export")}
          >
          ...
          <CommandItem
            value="action:layout"
            onSelect={() => handleSelect("action:layout")}
          >
          ...
          <CommandItem
            ...
            onSelect={() => handleSelect("action:duplicate")}
          >
          ...
          <CommandItem
            value="action:snap"
            onSelect={() => handleSelect("action:snap")}
          >
        ...
        <CommandGroup heading="Componentes">
          {allComponents.map((comp) => (
            <CommandItem
              ...
              onSelect={() => handleSelect(`component:${comp.id}`)}
            >
