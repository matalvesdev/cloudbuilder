import { Plus, CheckCircle, X, BrainCircuit, Workflow, ChevronDown, ChevronRight, ExternalLink, Layers } from 'lucide-react'
...
export function DesignPreview({ msg, expandedResources, onToggleResource, onOpenInCanvas }: DesignPreviewProps) {
