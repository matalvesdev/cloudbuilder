...
const resourceChanges: ResourceChange[] = [
  {
    ...
    address: "module.vpc.aws_instance.main",
    type: "added",
  },
  {
    id: "2",
    name: "aws_security_group.allow_tls",
    address: "module.security.aws_sg.main",
    type: "added",
  },
  {
    id: "3",
    name: "aws_s3_bucket.logs",
    address: "module.storage.s3_bucket",
    type: "modified",
  },
  {
    id: "4",
    name: "aws_lb_target_group.front_end",
    address: "module.lb.tg",
    type: "modified",
  },
];
...
const terminalLines = [
  {
    line: 1,
    text: "Terraform foi inicializado com sucesso!",
    color: "text-slate-400",
  },
  { line: 2, text: "", color: "text-slate-400" },
  {
    line: 3,
    text: "Terraform usou os provedores selecionados para gerar o seguinte plano de execução. As ações são indicadas com os seguintes símbolos:",
    color: "text-slate-600",
  },
  { line: 4, text: "  + criar", color: "text-green-500 font-medium" },
  {
    line: 5,
    text: "  ~ atualizar no local",
    color: "text-blue-500 font-medium",
  },
  { line: 6, text: "", color: "text-slate-400" },
  {
    line: 7,
    text: "O Terraform executará as seguintes ações:",
    color: "text-slate-600",
  },
  { line: 8, text: "", color: "text-slate-400" },
  {
    line: 9,
    text: "  # aws_instance.web_server será criado",
  ...
  {
    line: 11,
    text: '  + ami                          = "ami-0c55b159cbfafe1f0"',
    color: "text-slate-500",
  },
  {
    line: 12,
  ...
  {
    line: 13,
    text: "  + availability_zone            = (conhecido após aplicar)",
    color: "text-slate-500",
  },
  {
    line: 14,
    text: '  + key_name                     = "production-key"',
    color: "text-slate-500",
  },
  ...
  {
    line: 17,
    text: "  # aws_s3_bucket.logs será atualizado no local",
    color: "text-slate-700",
  },
  {
    line: 18,
  ...
  {
    line: 25,
    text: "Plano: 12 para adicionar, 4 para alterar, 0 para destruir.",
      ...
      <div className="h-16 bg-white border-b border-slate-100 flex items-center justify-between px-6 shrink-0">
        <div className="flex items-center gap-4">
          ...
          <nav className="flex items-center gap-1.5 text-sm text-slate-500">
            <span className="hover:text-brand-navy cursor-pointer transition-colors">
              Projetos
            </span>
            ...
            <ChevronRight className="w-3.5 h-3.5 text-slate-300" />
            <span className="text-brand-navy font-semibold bg-slate-50 px-2 py-0.5 rounded border border-slate-100">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className="w-20 flex flex-col items-center py-6 gap-6 bg-white border-r border-slate-100 shrink-0">
          <button className="w-10 h-10 rounded-xl flex items-center justify-center text-slate-400 hover:text-brand-navy hover:bg-slate-50 transition-all group relative">
            ...
            <span className="absolute left-14 bg-brand-navy text-white text-xs px-2 py-1 rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap font-medium z-50">
              Dashboard
            </span>
          </button>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="h-28 px-8 flex items-center justify-between shrink-0 border-b border-slate-50">
            <div className="flex items-start gap-4">
              <div className="hidden xl:flex flex-col items-start gap-1 p-2 bg-white border border-slate-200 rounded shadow-sm w-32 shrink-0">
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(90deg, #0a1128 0%, #0a1128 4%, transparent 4%, transparent 6%, #0a1128 6%, #0a1128 8%, transparent 8%, transparent 9%, #0a1128 9%, #0a1128 14%, transparent 14%, transparent 16%, #0a1128 16%, #0a1128 20%, transparent 20%, transparent 24%, #0a1128 24%, #0a1128 26%, transparent 26%, transparent 28%, #0a1128 28%, #0a1128 32%, transparent 32%, transparent 34%, #0a1128 34%, #0a1128 40%, transparent 40%, transparent 45%, #0a1128 45%, #0a1128 55%, transparent 55%, transparent 60%, #0a1128 60%, #0a1128 65%)",
                    opacity: 0.8,
                  }}
                />
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                className="w-10 h-10 rounded-lg border border-slate-200 text-slate-400 hover:text-red-500 hover:border-red-200 hover:bg-red-50 transition-all flex items-center justify-center"
                title="Destruir Infraestrutura"
              >
            ...
            <div className="w-1/3 flex flex-col gap-5 min-w-[360px]">
              ...
              <div className="flex-1 bg-white rounded-xl card-shadow border border-slate-100 flex flex-col overflow-hidden">
                <div className="p-5 border-b border-slate-100 flex justify-between items-center bg-slate-50">
                  <h3 className="font-bold text-brand-navy text-sm tracking-wide">
                    Alterações de Recursos
                  </h3>
                  <span className="px-2 py-1 bg-white rounded border border-slate-200 text-xs font-mono text-slate-500 shadow-sm">
                    16 recursos
                  </span>
                </div>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            <span className="text-sm font-bold text-slate-700 truncate group-hover:text-brand-navy transition-colors">
                              {r.name}
                            </span>
                          </div>
                          <div className="text-xs text-slate-400 mt-1 truncate font-mono bg-slate-50 inline-block px-1 rounded">
                            {r.address}
                          </div>
                        </div>
            ...
            <div className="flex-1 bg-slate-50 rounded-xl flex flex-col overflow-hidden card-shadow border border-slate-200 relative">
              ...
              <div className="h-12 bg-white border-b border-slate-200 flex items-center justify-between px-4 shrink-0">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    className="text-slate-400 hover:text-brand-navy transition-colors p-1 hover:bg-slate-100 rounded"
                    title="Copiar Logs"
                  >
                    ...
                    {terminalLines.map((line) => (
                      <div
                        ...
                        className={cn(
                          "flex",
                          line.highlight &&
                            "bg-blue-50 -mx-6 px-6 border-l-4 border-brand-navy py-1 mt-2 mb-1",
                        )}
                      >
                        <span className="w-8 select-none text-right mr-6 opacity-30 text-xs mt-[2px] font-bold text-slate-400 shrink-0">
                          {line.line}
                        </span>
                        <span className={cn(line.color, "whitespace-pre-wrap")}>
                          {line.text}
                        </span>
                      </div>
                    ))}
