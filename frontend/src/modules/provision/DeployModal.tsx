        ...
        <div className="p-6 border-b border-slate-100">
          ...
          <p className="text-xs text-slate-400 mt-0.5">
            {deployStep === 'plan' ? 'Analisando recursos e detectando mudanças...' :
             ...
             deployStep === 'applying' ? `Provisionando ${resourceCount} recursos na nuvem` :
             deployStep === 'done' ? `${resourceCount} recursos provisionados com sucesso` :
        ...
        <div className="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
          ...
          <div className="bg-slate-50 rounded-xl p-4 space-y-2">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-semibold text-brand-navy">{ENVIRONMENT_TYPE_LABELS[selectedEnvironment.type as keyof typeof ENVIRONMENT_TYPE_LABELS]}</span>
            </div>
            <div className="flex items-center justify-between text-sm">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-4 rounded-xl bg-amber-50 border border-amber-200">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-500">Aplicando {resourceCount} recursos via Terraform</p>
                </div>
              </div>
