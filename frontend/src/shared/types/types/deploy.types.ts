export type AppDeployStatus = 'pending' | 'deploying' | 'running' | 'success' | 'failed' | 'cancelled'

export type AppType = 'web-app' | 'microservice' | 'data-pipeline' | 'docker-compose' | null

export type CiProvider = 'github_actions' | 'gitlab_ci'

export type DeployTargetType = 'ecs_service' | 'lambda' | 'k8s_deployment' | 'ec2'
