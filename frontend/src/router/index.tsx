...
export const DashboardModule = lazyImport(() => import('@/modules/dashboard/DashboardModule'), 'DashboardModule')
export const CanvasModule = lazyImport(() => import('@/modules/canvas/DesignModule'), 'DesignModule')
export const ProvisioningModule = lazyImport(() => import('@/modules/provisioning/ProvisionModule'), 'ProvisionModule')
export const ObservabilityModule = lazyImport(() => import('@/modules/observability/ObserveModule'), 'ObserveModule')
export const FinOpsModule = lazyImport(() => import('@/modules/finops/CostModule'), 'CostModule')
export const PlatformModule = lazyImport(() => import('@/modules/platform/PlatformModule'), 'PlatformModule')
export const AIModule = lazyImport(() => import('@/modules/ai/AIOpsModule'), 'AIOpsModule')
 ...
 */
export const moduleHierarchy: Record<string, { section: string; path: string[] }> = {
  dashboard: { section: 'Visão Geral', path: ['Dashboard'] },
  canvas: { section: 'Infraestrutura', path: ['Infraestrutura', 'Canvas'] },
  provisioning: { section: 'Infraestrutura', path: ['Infraestrutura', 'Provisionamento'] },
  observability: { section: 'Operações', path: ['Operações', 'Observabilidade'] },
