...
export function GatewaySetup({ onComplete, onSkip }: GatewaySetupProps) {
  ...
  const [repoProvider, setRepoProvider] =
    useState<RepoConfig["provider"]>("github");
  ...
  const canGoNext = useCallback(() => {
    switch (step) {
      case 0:
        return repoUrl.trim().length > 0 && repoUrl.includes("/");
      case 1:
  ...
  const handleNext = useCallback(async () => {
    ...
    if (step === 2 && canGoNext()) {
      ...
      const tenantId =
        localStorage.getItem("cloudbuilder-active-tenant") || "default";
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              Conecte seu repositório e provedor de nuvem
            </p>
          </div>
        </div>
        <button
            ...
            <div className="space-y-5 animate-in fade-in slide-in-from-right-4 duration-200">
              <div>
                ...
                <p className="text-sm text-slate-400 mt-1">
                  Informe o repositório Git da sua infraestrutura para
                  importarmos recursos existentes.
                </p>
              </div>
                    ...
                    {[
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          repoProvider === g.id
                            ? "border-brand-navy bg-slate-50 shadow-sm"
              ...
              {repoUrl && (
                <div className="rounded-xl bg-ice-blue/20 border border-slate-200 p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-brand-navy">
                      Scan automático disponível
                    </span>
                  </div>
                  <p className="text-xs text-slate-500 mt-1">
                    Após conectar, o CloudBuilder escaneará o repositório em
                    busca de arquivos Terraform, CloudFormation, Pulumi e
                    Kubernetes para importar automaticamente.
                  </p>
                </div>
              )}
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      {Object.entries(ENVIRONMENT_TYPE_LABELS).map(([k, l]) => (
              ...
              <div className="rounded-xl bg-ice-blue/30 border border-slate-200 p-4 space-y-2">
                ...
                <div className="space-y-1.5 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-brand-navy truncate ml-2">
                      {repoUrl || "—"}
                    </span>
                  </div>
                  <div className="flex justify-between">
