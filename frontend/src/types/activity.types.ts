export type ActivityType =
  | 'design_save' | 'design_validate' | 'design_import'
  | 'deploy_start' | 'deploy_success' | 'deploy_fail' | 'deploy_promote'
  | 'drift_detected' | 'drift_remediated' | 'drift_accepted'
  | 'cost_anomaly' | 'cost_optimization' | 'cost_saving'
  | 'compliance_violation' | 'compliance_fixed' | 'compliance_ok'
  | 'approval_requested' | 'approval_approved' | 'approval_rejected'
  | 'collaboration_comment' | 'collaboration_shared'
  | 'ai_analysis' | 'ai_autofix'
  | 'credential_added' | 'credential_expired'
  | 'environment_created' | 'pipeline_run'
  | 'user_login' | 'team_member_added'
