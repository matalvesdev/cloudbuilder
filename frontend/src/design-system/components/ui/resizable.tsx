...
export function ResizablePanelGroup({ className, orientation = 'horizontal', children }: ResizablePanelGroupProps) {
  return (
    <div
...
export function ResizablePanel({ className, defaultSize, minSize, ...props }: React.ComponentProps<'div'> & { defaultSize?: number; minSize?: number }) {
...
export function ResizableHandle({ withHandle, className, orientation = 'horizontal', ...props }: ResizableHandleProps) {
